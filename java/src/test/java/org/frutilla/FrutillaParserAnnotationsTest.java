...
public class FrutillaParserAnnotationsTest {
    ...
    public void testGivenFromAnnotationNull() throws Exception {
        ...
        String sentence = scenario(mMockFrutilla);
    ...
    @Test
    public void testScenarioFromAnnotation() throws Exception {
        mockScenarioAnnotation(SCENARIO);
        String sentence = scenario(mMockFrutilla);

        assertEquals("SCENARIO " + SCENARIO, sentence);
    }
    ...
    @Frutilla(
            ...
            When = "process it",
            Then = {
                    "sentence has SCENARIO",
                    "AND the two sentences"
            }
    )
    @Test
    public void testScenarioMultipleFromAnnotation() throws Exception {
        mockScenarioAnnotation(SCENARIO, ONE, TWO);
        String sentence = scenario(mMockFrutilla);

        assertEquals("SCENARIO " + SCENARIO + ONETWO, sentence);
    }
    ...
    private void mockScenarioAnnotation(String... text) {
        when(mMockFrutilla.Scenario()).thenReturn(text);
    }
